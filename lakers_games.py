...
def get_lakers_games(start_year, current_year, team_id):
    """
    Fetches games for the LA Lakers for specified seasons.

    Parameters:
    start_year (int): The starting year of the season range.
    current_year (int): The ending year of the season range.
    team_id (int): The team ID for the LA Lakers.
...
def main():
    ...
    lakers_games = get_lakers_games(2016, current_year, lakers_team_id)
    extracted_lakers_games = extract_game_info(lakers_games)
    insert_games_into_db(extracted_lakers_games)
