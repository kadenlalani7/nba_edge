    ...
    for stat in stats:
        ...
        try:
            ...
            cur.execute(
                ...
                (stat['player']['id'], stat['game']['id'], stat['ast'], stat['blk'], stat['dreb'], stat['fg3_pct'], stat['fg3a'], stat['fg3m'], stat['fg_pct'], stat['fga'], stat['fgm'], stat['ft_pct'], stat['fta'], stat['ftm'], minutes, stat['oreb'], stat['pf'], stat['pts'], stat['reb'], stat['stl'], stat['turnover'], stat['player']['id'], stat['game']['id'])
            )
